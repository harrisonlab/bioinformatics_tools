...
input=/projects/neonectria_ditissima/analysis/genome_alignment/bowtie
reference=/projects/neonectria_ditissima/repeat_masked/filtered_contigs/R0905_contigs_unmasked.fa
