...
for i in $(seq 1 $Iterations); do
  ...
  #samtools index -@ 8 assembly.fa_aligned_sorted.bam
  ...
  if [ $Ploidy == "haploid" ]; then
    pilon --genome assembly.fa --changes --bam ../assembly.fa_aligned_sorted.bam --outdir .
    #pilon --threads $Threads --genome assembly.fa --changes --frags assembly.fa_aligned_sorted.bam --outdir .
  elif [ $Ploidy == "diploid" ]; then
    pilon --genome assembly.fa --changes --diploid --bam ../assembly.fa_aligned_sorted.bam --outdir .
